        ...
        if c.heroclass["cooldown"] <= time.time():
            ...
            if good:
                ...
                if session.no_monster:
                    ...
                    msg += _(f"Your third eye reveals this monster's weakness. {self.view.cog.emojis.dice}({int(round(roll * max_roll))})\n")
                    ...
                    if roll >= 0.98:
                        ...
                        if self.view.rng.choice(["hp", "dipl"]) == "hp":
                            hp = session.monster_hp()
                    ...
                    if roll >= 0.98:
                        ...
                        revealed_stats = self.view.rng.sample(["physical", "magic", "diplomacy"], self.view.rng.choice([1, 2]))
